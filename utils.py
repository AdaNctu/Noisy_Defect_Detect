...
def plot_sample(image_name, image, segmentation, label, h_label, save_dir, decision=None, blur=False, plot_seg=False):
    plt.figure()
    plt.clf()
    plt.subplot(1, 4, 1)
    plt.xticks([])
    ...
    plt.imshow(segmentation, cmap="gray",vmax=1.0)
